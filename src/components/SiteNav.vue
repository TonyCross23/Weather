<template>
  <header class="sticky top-0 bg-weather-primary shadow-lg">
    <nav
      class="container flex flex-col sm:flex-row items-center gpa-4 text-white py-6"
    >
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fas fa-info-circle text-xl hover:text-weather-secondary duration-150 cusor-pointer"
          @click="toggleModal"
        ></i>
        <i
